...
use Aktaa\translatable\Exceptions\SupportedLangNotDefined;
use Aktaa\translatable\Exceptions\UnsupportedLangException;
...
class Translatable
{
     ...
     *
     * @throws SupportedLangNotDefined
    ...
    public function __construct()
    {
        ...
        $supportedLangs = $this->getSupportedLocales();

        if (empty($supportedLangs[$this->defaultLocale])) {
            throw new UnsupportedLangException('Laravel default locale is not in the supportedLangs array.');
        }
    }
    ...
    public function setLocale($locale = null)
    {
        ...
        if (!empty($this->supportedLangs[$locale])) {
    ...
    public function getLocalizedURL($locale = null, $url = null, $attributes = [], $forceDefaultLocation = false)
    {
        ...
        if (!$this->checkLocaleInSupportedLocales($locale)) {
            throw new UnsupportedLangException('Locale \''.$locale.'\' is not in the list of supported locales.');
        }
    ...
    public function getNonLocalizedURL($url = null)
    {
        ...
        } catch (SupportedLangNotDefined $e) {
    ...
    {
        if (!empty($this->supportedLangs)) {
            return $this->supportedLangs;
        }

        $locales = $this->configRepository->get('translatable.supportedLangs');

        if (empty($locales) || !is_array($locales)) {
            throw new SupportedLangNotDefined();
        }
    ...
    {
        return $this->supportedLangs[$this->getCurrentLocale()]['name'];
    }
    ...
    {
        return $this->supportedLangs[$this->getCurrentLocale()]['native'];
    }
    ...
    {
        if (!empty($this->supportedLangs[$this->getCurrentLocale()]['dir'])) {
            return $this->supportedLangs[$this->getCurrentLocale()]['dir'];
        }
    ...
    {
        return $this->supportedLangs[$this->getCurrentLocale()]['script'];
    }
    ...
    public function getCurrentLocaleRegional()
    {
        ...
        if (isset($this->supportedLangs[$this->getCurrentLocale()]['regional'])) {
            return $this->supportedLangs[$this->getCurrentLocale()]['regional'];
        } else {
            return;
        }
    }
    ...
    {
        return $this->configRepository->get('translatable.useAcceptLanguageHeader');
    }
    ...
    {
        return $this->configRepository->get('translatable.hideDefaultLocaleInURL');
    }
